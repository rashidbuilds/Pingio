      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 h-[80px] flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <a
            ...
            className="w-10 h-10 flex items-center justify-center rounded-lg text-foreground/70 hover:text-foreground hover:bg-muted/30 transition-all duration-150"
          >
